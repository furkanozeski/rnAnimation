  ...
  return (
    <View style={[styles.introScreenMainContainer, { backgroundColor: theme?.colorScheme.background }]}>
      ...
      <View style={styles.introScreenButtonViewContainer}>
        ...
        >
          <Text style={{ color: theme?.colorScheme.textColor }}>Create Account</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.introScreenCountinueAsAnonButton, { backgroundColor: theme?.colorScheme.secondary, }]}>
